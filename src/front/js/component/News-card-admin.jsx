            ...
            <picture className="picture">
                ...
                <div className="news-body">
                    ...
                    <div className="d-flex">
                        <button type="button" className="news-btn btn-dark" onClick={(e) => handleDelete(props.id)}>Delete</button>
                        <button type="button" className="news-btn btn-dark" onClick={(e) => handleUpdate(props.id)}>Update new</button>
                    </div>
